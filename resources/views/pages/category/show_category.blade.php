                            ...
                            <div class="col-md-4">
                                    ...
                                    <form>
                                        ...
                                        <div class="style-range" >
                                            <p><input type="text" id="amount_start" readonly style="border:0; color:#141E61; font-weight:bold;"></p>
                                            <p><input type="text" id="amount_end" readonly style="border:0; color:#141E61; font-weight:bold;"></p>
                                        </div>
